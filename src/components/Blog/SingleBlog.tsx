    ...
    <>
      <div className="group shadow-one hover:shadow-two dark:bg-dark dark:hover:shadow-gray-dark relative flex h-full flex-col overflow-hidden rounded-xs bg-white duration-300">
        ...
        <div className="flex flex-1 flex-col p-6 sm:p-8 md:px-6 md:py-8 lg:p-8 xl:px-5 xl:py-8 2xl:p-8">
          <h3 className="min-h-[64px]">
            <Link
              href={blog.link}
              className="hover:text-primary dark:hover:text-primary mb-4 line-clamp-2 block text-xl font-bold text-black sm:text-2xl dark:text-white"
            >
              {title}
            </Link>
          </h3>
          <p className="border-body-color/10 text-body-color mb-6 line-clamp-3 border-b pb-6 text-base font-medium dark:border-white/10">
            {paragraph}
          </p>
